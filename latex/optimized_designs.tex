...
\begin{figure}[tph]
\begin{subfigure}{0.50\textwidth}
\includegraphics[width=\linewidth]{figures/KB6_final/KB6_r01_thickness.eps}
...
\caption{Laminate layup}
\label{subfig:KB6_layers_r01}
\end{subfigure}
\caption{ Material in the trailing edge reinforcement of the KB6 blade.}
...
\begin{figure}[tph]
\begin{subfigure}{0.50\textwidth}
\includegraphics[width=\linewidth]{figures/KB6_final/KB6_r02_thickness.eps}
\caption{Laminate thickness comparison with reference}
...
\end{subfigure}
\caption{ Material in the main panel (immediately behind the spar cap) of the KB6 blade.}
...
\begin{figure}[tph]
\begin{subfigure}{0.50\textwidth}
\includegraphics[width=\linewidth]{figures/KB6_final/KB6_r04_thickness.eps}
\caption{Laminate thickness comparison with reference}
...
\end{subfigure}
\caption{ Material in the spar cap of the KB6 blade.}
...
\begin{figure}[tph]
\begin{subfigure}{0.50\textwidth}
\includegraphics[width=\linewidth]{figures/KB6_final/KB6_r06_thickness.eps}
\caption{Laminate thickness comparison with reference}
...
\end{subfigure}
\caption{ Material in the leading region (immediately in front of the spar cap) of the KB6 blade.}
...
\begin{figure}[tph]
\begin{subfigure}{0.50\textwidth}
\includegraphics[width=\linewidth]{figures/KB6_final/KB6_r07_thickness.eps}
\caption{Laminate thickness comparison with reference}
...
\end{subfigure}
\caption{ Material in the leading edge reinforcement of the KB6 blade.}
